...
<html>
    ...
    ?>
        <?php   
                if(mysqli_query($conexion, "INSERT INTO usuario(alias, password, correo, nombre, pais, ciudad, direccion, cod_postal) VALUES ('$alias_target', '$pass_target', '$email_target', '$nombre','$pais', '$ciudad', '$direccion', '$cod_postal')")){
